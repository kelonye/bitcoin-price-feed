...
module.exports = {
  ...
  networks: {
    ...
    ropsten: {
      provider: () =>
        new HDWalletProvider(process.env.MNENOMIC, "https://ropsten.infura.io/v3/" + process.env.INFURA_API_KEY, 2),
      network_id: 3,
      gas: 3000000,
    ...
    kovan: {
      provider: () =>
        new HDWalletProvider(process.env.MNENOMIC, "https://kovan.infura.io/v3/" + process.env.INFURA_API_KEY, 2),
      network_id: 42,
      gas: 3000000,
      gasPrice: 10000000000,
    },
    ...
    main: {
      provider: () =>
        new HDWalletProvider(process.env.MNENOMIC, "https://mainnet.infura.io/v3/" + process.env.INFURA_API_KEY, 0),
      network_id: 1,
      gas: 3000000,
      gasPrice: 10000000000,
    },
